...
TEST(GraphK4D3Test, K4) {
  ...
  for (int v = 0; v < 4; v++) {
    EXPECT_FALSE(contains_K4D0(g, v));
  }
  ...
  ASSERT_TRUE(Graph::parse_edges("{01, 02>2, 03>0, 12>2, 13>3, 23>3}", g));
  for (int v = 0; v < 4; v++) {
    EXPECT_FALSE(contains_K4D0(g, v));
  }

  ASSERT_TRUE(Graph::parse_edges("{01>1, 02>2, 03>3, 12>2, 13>3, 23>3}", g));
  for (int v = 0; v < 4; v++) {
    EXPECT_TRUE(contains_K4D0(g, v));
  }

  ASSERT_TRUE(Graph::parse_edges("{01>1, 02>2, 03>3, 12>2, 13>1, 23>3}", g));
  for (int v = 0; v < 4; v++) {
    EXPECT_FALSE(contains_K4D0(g, v));
  }
}
...
TEST(GraphK4D3Test, K5) {
  ...
  EXPECT_FALSE(contains_K4D0(g, 0));
  ...
  ASSERT_TRUE(Graph::parse_edges("{04, 01>1, 02>2, 03>3, 12>2, 13>3, 23>3}", g));
  for (int v = 0; v < 4; v++) {
    EXPECT_TRUE(contains_K4D0(g, v));
  }
  EXPECT_FALSE(contains_K4D0(g, 4));
}